...
import GlobalImpactSimulation from "../components/formula/GlobalImpactSimulation";
...
export default function SellFormula() {
  ...
  const handleBuyerClick = (buyer) => {
    ...
    setShowImpactSimulation(false); // Close impact simulation when selecting a new buyer
  };
  ...
  const handleNuxelandClick = () => {
    ...
    setNegotiationStage(null);
    setShowImpactSimulation(false); // Close impact simulation when viewing Nuxeland
  };
  ...
  const startNegotiation = () => {
    ...
    setTermDecisions({});
    setBuyerTermDecisions({});
    setShowImpactSimulation(false); // Hide impact simulation when starting negotiation
  };

  const viewImpactSimulation = () => {
    setShowImpactSimulation(true);
    setNegotiationStage(null); // Ensure negotiation modal is closed
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            {selectedBuyer && !negotiationStage && (
              <Card className="bg-[#0F1729] border-green-500/50">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button onClick={viewImpactSimulation} variant="outline" className="w-full border-cyan-500/50 text-cyan-400 hover:bg-cyan-500/20 font-mono">
            ...
            {!selectedBuyer && !showNuxelandMap && !showImpactSimulation && (
        ...
        {showImpactSimulation && selectedBuyer && (
          <GlobalImpactSimulation 
            buyer={selectedBuyer} 
            onClose={() => setShowImpactSimulation(false)} 
          />
        )}
      </div>
    </div>
