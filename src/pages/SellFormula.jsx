              ...
              <CardContent>
                <div
                  ...
                  <button
                    ...
                    selectedBuyer?.id === buyer.id ? 'ring-green-400 scale-150' : 'ring-green-900'} group-hover:scale-150 transition-all duration-300`
                    }>
                        <div className="bg-green-400 mx-5 opacity-50 rounded-full absolute inset-0 animate-ping"></div>
                      </div>
                  ...
                  <button
                    ...
                    showNuxelandMap ? 'ring-red-400 scale-150' : 'ring-red-900'} group-hover:scale-150 transition-all duration-300`
                    }>
