...
import { FlaskConical, Sparkles, Trash2, Beaker } from "lucide-react";
...
export default function ExperimentLab() {
  ...
  const knownCombinations = {
    'H2O': { name: 'Water', effect: 'Hydration boost', color: '#3b82f6' },
    'HO': { name: 'Hydroxide', effect: 'Cleansing agent', color: '#10b981' },
    'CH2': { name: 'Methylene', effect: 'Energy booster', color: '#f59e0b' },
    'NCO': { name: 'Cyan Essence', effect: 'Mind clarity', color: '#06b6d4' },
    'NHC': { name: 'Amino Base', effect: 'Growth accelerator', color: '#8b5cf6' },
    'CaN': { name: 'Calcium Nitride', effect: 'Bone strengthener', color: '#ef4444' },
    'FeO': { name: 'Iron Oxide', effect: 'Rust protection', color: '#dc2626' },
    'MgC': { name: 'Magnesium Carbon', effect: 'Fire starter', color: '#f97316' },
  };
            ...
            <div className={`p-4 rounded-lg border-2 ${
              ...
              {result.success ? (
                <>
                  ...
                  <p className="text-gray-300 text-sm">{result.potion.effect}</p>
                </>
              ) : (
